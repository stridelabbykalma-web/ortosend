...
import { newCaseBAction } from "@/app/panel/clinica-actions";
    ...
    <>
      ...
      <details className="card">
        ...
        <form action={newCaseBAction}>
          ...
          <div className="tiny" style={{ marginTop: 8 }}>
            El consentimiento RGPD se recoge en clínica. El paciente activa su cuenta desde el enlace de
            invitación (WhatsApp). El estudio empieza ahora; si viene otro día, dale cita arriba.
          </div>
        </form>
      </details>
      <div className="sp" />
